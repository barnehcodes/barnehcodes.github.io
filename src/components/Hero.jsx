      ...
      >
        ...
        <div>
          <h1 className={`${styles.heroHeadText} text-white`}>
            Hi, I'm <span className="text-[#915eff]">Otmane</span>
          </h1>
          <p className={`${styles.heroSubText} mt-2 text-white-100`}>
            {" "}
            I'm a computer engineering student and this is my profilio that
            displays some insight on my qualafications :/{" "}
          </p>
        </div>
      </div>
      <ComputersCanvas />
